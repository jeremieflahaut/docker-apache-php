...
cp .deploy/php/php.ini /usr/local/etc/php/conf.d/app.ini
...
cp .deploy/index.php /var/www/html/public/index.php
...
#Cron & Logrotate
cp "/.deploy/logrotate/logrotate_apache.conf" /etc/logrotate.d/apache2
cp "/.deploy/logrotate/logrotate_laravel.conf" /etc/logrotate.d/laravel
chown -R root:debian /var/log/apache2
